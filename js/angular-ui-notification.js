...
angular.module('ui-notification').provider('Notification', function() {
    ...
    this.$get = function($timeout, $http, $compile, $templateCache, $rootScope, $injector, $sce, $q, $window) {
        ...
        var notify = function(args, t){
            ...
            args.template = "<div class=\"ui-notification\"><h3 ng-show=\"title\" ng-bind-html=\"title\"></h3><div class=\"message\" ng-bind-html=\"message\"></div></div>";//args.templateUrl ? args.templateUrl : options.templateUrl;
            ...
            var template = args.template;//$templateCache.get(args.template);
